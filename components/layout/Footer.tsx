  ...
  return (
    <footer className="bg-[#1e1e1e] text-white py-12 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-gray-700/50 pb-10 mb-10">
          
          {/* Logo & Tagline - Column 1 */}
        ...
        {/* Bottom Section: Contact & Addresses (3 equal columns) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          {/* India Office - Column 3 */}
          <div className="flex flex-col justify-start">
            <h4 className="font-bold text-base mb-4">
              <img src='https://cdn.prod.website-files.com/6718c309cc349b579872ddbb/673c2edf97f8bb52c7e28017_india-svgrepo-com.svg' alt="India Flag" className="inline-block w-4 h-4 mr-2" />
              {officeIND.title}
            </h4>
            <p className="text-gray-400 text-sm">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-4 border-t border-gray-700/50">
          ...
          <div className="flex space-x-4">
            ...
            <Link href="https://www.facebook.com/SBGlobalAccounting/" className="hover:text-[var(--primary-color)] transition">
